...
import { cobolKeywordDictionary, cobolProcedureKeywordDictionary, cobolStorageKeywordDictionary } from "./gnuCobolKeywords";
...
export default class COBOLSourceScanner implements ICommentCallback, ICOBOLSourceScanner {
    ...
    public getCopyFilename(copybook: string, inInfo: string): string {
        ...
        return this.externalFeatures.expandLogicalCopyBookToFilenameOrEmpty(trimmedCopyBook, inInfo);
    }
                        ...
                        switch (tcurrentLower) {
                            ...
                            default: {
                                ...
                                if (cbState.isReplacingBy) {
                                    if (state.enable_text_replacement) {
